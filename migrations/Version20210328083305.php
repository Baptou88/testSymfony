 ...
 */
final class Version20210328083305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C82E741EDE0F55');
        $this->addSql('CREATE TEMPORARY TABLE __temp__clients AS SELECT id, name FROM clients');
        $this->addSql('DROP TABLE clients');
        $this->addSql('CREATE TABLE clients (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO clients (id, name) SELECT id, name FROM __temp__clients');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__clients AS SELECT id, name FROM clients');
        $this->addSql('DROP TABLE clients');
        $this->addSql('CREATE TABLE clients (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, projects_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO clients (id, name) SELECT id, name FROM __temp__clients');
        $this->addSql('DROP TABLE __temp__clients');
        $this->addSql('CREATE INDEX IDX_C82E741EDE0F55 ON clients (projects_id)');
        $this->addSql('DROP INDEX IDX_5C93B3A4B407C362');
