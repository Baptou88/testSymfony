 ...
 */
final class Version20210326190052 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE clients (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) DEFAULT NULL COLLATE BINARY, postalcode VARCHAR(20) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_5C93B3A4B407C362');
        $this->addSql('CREATE TEMPORARY TABLE __temp__projects AS SELECT id, type_projet_id, code, date_entree, date_delai, type, description FROM projects');
        $this->addSql('DROP TABLE projects');
        $this->addSql('CREATE TABLE projects (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_projet_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL, date_entree DATETIME NOT NULL, date_delai DATETIME DEFAULT NULL, type INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, client_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO projects (id, type_projet_id, code, date_entree, date_delai, type, description) SELECT id, type_projet_id, code, date_entree, date_delai, type, description FROM __temp__projects');
        $this->addSql('DROP TABLE __temp__projects');
        $this->addSql('CREATE INDEX IDX_5C93B3A4B407C362 ON projects (type_projet_id)');
