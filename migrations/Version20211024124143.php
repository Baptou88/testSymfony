 ...
 */
final class Version20211024124143 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_167C49E71B65292');
        $this->addSql('DROP INDEX IDX_167C49E7166D1F9C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__heure_projet AS SELECT id, project_id, date, duree, is_hidden, employe_id FROM heure_projet');
        $this->addSql('DROP TABLE heure_projet');
        $this->addSql('CREATE TABLE heure_projet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, date DATETIME NOT NULL, duree DOUBLE PRECISION NOT NULL, is_hidden BOOLEAN NOT NULL, employe_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO heure_projet (id, project_id, date, duree, is_hidden, employe_id) SELECT id, project_id, date, duree, is_hidden, employe_id FROM __temp__heure_projet');
        $this->addSql('DROP TABLE __temp__heure_projet');
        $this->addSql('CREATE INDEX IDX_167C49E71B65292 ON heure_projet (employe_id)');
        $this->addSql('CREATE INDEX IDX_167C49E7166D1F9C ON heure_projet (project_id)');
        $this->addSql('DROP INDEX IDX_5C93B3A4B407C362');
