 ...
 */
final class Version20211025153109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image_file VARCHAR(255) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INTEGER DEFAULT NULL, update_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('DROP INDEX IDX_167C49E7166D1F9C');
        $this->addSql('DROP INDEX IDX_167C49E71B65292');
        $this->addSql('CREATE TEMPORARY TABLE __temp__heure_projet AS SELECT id, project_id, employe_id, date, duree, is_hidden FROM heure_projet');
        $this->addSql('DROP TABLE heure_projet');
        $this->addSql('CREATE TABLE heure_projet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, employe_id INTEGER NOT NULL, date DATETIME NOT NULL, duree DOUBLE PRECISION NOT NULL, is_hidden BOOLEAN NOT NULL, CONSTRAINT FK_167C49E7166D1F9C FOREIGN KEY (project_id) REFERENCES projects (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_167C49E71B65292 FOREIGN KEY (employe_id) REFERENCES employes (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO heure_projet (id, project_id, employe_id, date, duree, is_hidden) SELECT id, project_id, employe_id, date, duree, is_hidden FROM __temp__heure_projet');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__heure_projet AS SELECT id, project_id, employe_id, date, duree, is_hidden FROM heure_projet');
        $this->addSql('DROP TABLE heure_projet');
        $this->addSql('CREATE TABLE heure_projet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, employe_id INTEGER NOT NULL, date DATETIME NOT NULL, duree DOUBLE PRECISION NOT NULL, is_hidden BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO heure_projet (id, project_id, employe_id, date, duree, is_hidden) SELECT id, project_id, employe_id, date, duree, is_hidden FROM __temp__heure_projet');
        $this->addSql('DROP TABLE __temp__heure_projet');
        $this->addSql('CREATE INDEX IDX_167C49E7166D1F9C ON heure_projet (project_id)');
        $this->addSql('CREATE INDEX IDX_167C49E71B65292 ON heure_projet (employe_id)');
