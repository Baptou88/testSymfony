 ...
 */
final class Version20210402141621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__projects AS SELECT id, type_projet_id, clients_id, code, date_entree, date_delai, type, description FROM projects');
        ...
        $this->addSql('INSERT INTO projects (id, type_projet_id, clients_id, code, date_entree, date_delai, type, description) SELECT id, type_projet_id, clients_id, code, date_entree, date_delai, type, description FROM __temp__projects');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__projects AS SELECT id, type_projet_id, clients_id, code, date_entree, date_delai, type, description FROM projects');
        $this->addSql('DROP TABLE projects');
        $this->addSql('CREATE TABLE projects (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_projet_id INTEGER DEFAULT NULL, clients_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL, date_entree DATETIME NOT NULL, date_delai DATETIME DEFAULT NULL, type INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO projects (id, type_projet_id, clients_id, code, date_entree, date_delai, type, description) SELECT id, type_projet_id, clients_id, code, date_entree, date_delai, type, description FROM __temp__projects');
        $this->addSql('DROP TABLE __temp__projects');
        $this->addSql('CREATE INDEX IDX_5C93B3A4B407C362 ON projects (type_projet_id)');
        $this->addSql('CREATE INDEX IDX_5C93B3A4AB014612 ON projects (clients_id)');
        ...
        $this->addSql('CREATE INDEX IDX_9B729C4F1EDE0F55 ON projects_option (projects_id)');
        $this->addSql('CREATE INDEX IDX_9B729C4FA7C41D6F ON projects_option (option_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, username, password, role, email FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO users (id, username, password, role, email) SELECT id, username, password, role, email FROM __temp__users');
