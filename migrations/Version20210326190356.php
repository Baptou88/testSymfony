 ...
 */
final class Version20210326190356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE projects (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_projet_id INTEGER DEFAULT NULL, clients_id_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL COLLATE BINARY, date_entree DATETIME NOT NULL, date_delai DATETIME DEFAULT NULL, type INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_5C93B3A4B407C362 FOREIGN KEY (type_projet_id) REFERENCES type_projet (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5C93B3A4A8C76A90 FOREIGN KEY (clients_id_id) REFERENCES clients (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_5C93B3A4A8C76A90 ON projects (clients_id_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5C93B3A4B407C362');
        $this->addSql('DROP INDEX IDX_5C93B3A4A8C76A90');
        $this->addSql('CREATE TEMPORARY TABLE __temp__projects AS SELECT id, type_projet_id, code, date_entree, date_delai, type, description FROM projects');
        $this->addSql('DROP TABLE projects');
